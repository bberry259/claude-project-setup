...
4. Paste the contents of `project-instructions-master.md` into your Claude Project's Instructions field. Customise the placeholder sections. Under GitHub access, choose a workflow mode: **direct push** (Claude commits straight to the default branch) or **branch and merge** (Claude pushes a feature branch, you open a PR and merge). Pick the one that fits your project and delete the other.
